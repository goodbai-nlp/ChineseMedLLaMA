...
class LLMTrainingArguments(TrainingArguments):
    ...
    peft_lora_r: Optional[int] = field(default=64, metadata={"help": "the r parameter (intrinsic rank) of the LoRA adapters"})
    peft_lora_alpha: Optional[int] = field(default=16, metadata={"help": "the alpha parameter (lr scale cofficient) of the LoRA adapters"})
